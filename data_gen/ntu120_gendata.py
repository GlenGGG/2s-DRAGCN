...
def gendata(data_path, out_path, ignored_sample_path=None,
    ...
    for filename in os.listdir(data_path):
        ...
        try:
            ...
            set_id = int(filename[filename.find('S') + 1:filename.find('S') +
                                  4])
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='NTU-RGB-D 120 Data Converter.')
    parser.add_argument(
        '--data_path',
        default='../data/nturgbd120_raw/nturgb+d120_skeletons/')
    parser.add_argument(
        '--ignored_sample_path',
        default='../data/nturgbd120_raw/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../data/ntu-120/')
